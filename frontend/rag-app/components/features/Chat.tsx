...
import { Box, TextField, IconButton, Typography, CircularProgress, Paper, Tooltip } from '@mui/material';
...
export default function Chat({ sessionId }: ChatProps) {
    ...
    // Fetch existing messages when sessionId changes
    useEffect(() => {
                        ...
                        <Tooltip title="Upload PDF">
                            <IconButton
                                ...
                                sx={{
                                    ...
                                    height: 36,
                                    flexShrink: 0,
                                    '&:hover': { color: 'primary.main', bgcolor: 'custom.surfaceHover' },
                                }}
                            >
                                {uploading ? <CircularProgress size={16} sx={{ color: 'inherit' }} /> : <AddIcon sx={{ fontSize: 20 }} />}
                            </IconButton>
                        </Tooltip>
                        <TextField
                            fullWidth
